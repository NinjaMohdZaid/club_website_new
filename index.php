...
<body>
    <?php
        require('frontend_config/navbar.php');
    ?>
    <div class="row">
        <video src="frontend_config/videos/cllllb1.mp4" autoplay="" loop="" muted="muted" controlslist="nodownload" href="frontend_config/videos/cllllb1.mp4"></video>
    </div>
    <div class="container my-2">
        <div class="row mx-auto">
            ...
            <div class="col-sm-6">
                <img src="frontend_config/images/cllllb1.jpeg" alt="" class="img-fluid" style="filter: grayscale(100%);">
            </div>
        </div>
    </div>
    <?php
