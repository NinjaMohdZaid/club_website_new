...
<nav class="navbar header-navbar pcoded-header">
               <div class="navbar-wrapper">
                   ...
                   <div class="navbar-container container-fluid">
                       ...
                       <ul class="nav-left d-flex justify-content-center align-items-center" style="width:44%;">
                            <img style="width:100px;" src="../assets/files/clubs/images/<?php echo $_SESSION['auth']['club_id'].'/'.$club_data['image_location']; ?>" alt="User-Profile-Image">
                       </ul>
                       <ul class="nav-right">
                           ...
                           <li class="user-profile header-notification">
                               <a href="#!">
                                   <span> <?php if($_SESSION['auth']['default_lang'] == 'ar') echo 'عربي'; else echo 'English'; ?> </span>
                           ...
                           <li class="user-profile header-notification">
                               ...
                               <ul class="show-notification profile-notification">
                                   <li>
                                       ...
                                       <i class="ti-layout-sidebar-left"></i> <?php echo $obj->__('logout',$_SESSION['auth']['default_lang']); ?>
                                   </a>
                                   </li>
                               </ul>
                           </li>
