...
<nav class="pcoded-navbar">
    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <?php if($_SESSION['auth']['club_type'] == 'G'){ ?>
                <li class="pcoded-hasmenu  <?php if ($current_file == 'manage_services.php' || $current_file == 'add_service.php' || $current_file == 'edit_service.php') echo 'active pcoded-trigger complete'; ?>">
                    <a href="javascript:void(0)">
                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main"><?php echo $obj->__('services', $_SESSION['auth']['default_lang']); ?></span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                    <ul class="pcoded-submenu">
                        <li class="<?php if ($current_file == 'add_service.php') echo 'active'; ?>">
                            <a href="add_service.php">
                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="font-weight: 400;"><?php echo $obj->__('add_service', $_SESSION['auth']['default_lang']); ?></span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if ($current_file == 'manage_services.php') echo 'active'; ?>">
                            <a href="manage_services.php">
                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs" style="font-weight: 400;"><?php echo $obj->__('manage_services', $_SESSION['auth']['default_lang']); ?></span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                    </ul>
