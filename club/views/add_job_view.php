...
<h2><?php echo $obj->__('add_job',$_SESSION['auth']['default_lang']); ?></h2>
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <label for="type"><input type="radio" name="type" value="F" checked><?php echo $obj->__('full_time',$_SESSION['auth']['default_lang']); ?></label>
        <label for="type"><input type="radio" name="type" value="P"><?php echo $obj->__('part_time',$_SESSION['auth']['default_lang']); ?></label>
        <label for="type"><input type="radio" name="type" value="C"><?php echo $obj->__('contract',$_SESSION['auth']['default_lang']); ?></label>
    </div>
    ...
    <input type="submit" value="<?php echo $obj->__('add_job',$_SESSION['auth']['default_lang']); ?>" name="add_job" class="btn btn-primary" >
