...
<?php 
    ...
    if(isset($_POST['create_order'])){
        ...
        if(!empty($rtn)){
            $rtn_msg = $obj->__('order_created_successfully',$_SESSION['auth']['default_lang']);
        }else{
            $rtn_msg = $obj->__('order_not_created_successfully',$_SESSION['auth']['default_lang']);
        }
    }
?>

<h2><?php echo $obj->__('create_order',$_SESSION['auth']['default_lang']); ?></h2>
