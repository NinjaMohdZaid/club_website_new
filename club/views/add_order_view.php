...
<?php 
    ...
    if(isset($_POST['create_order'])){
        ...
        if(!empty($rtn)){
            $rtn_msg = "Order created successfully";
        }else{
            $rtn_msg = "Order not created successfully";
        }
    }
?>
...
<form action="" method="post" enctype="multipart/form-data" class="form">
            ...
            <div class="card-box">
                <div class="appending_div">
                    <div class="form-group">
                        <hr>
                        <h5 class=" header-title">Products</h5>
                        ...
                        <label for="products[1][amount]">Amount<input type="number" name="amount" class="form-control" required></label>
                    </div>
                </div>
    ...
    <div class="form-group">
        <label for="user_data[name]">Customer Name</label>
        <input type="text" name="user_data[name]" class="form-control" required>
    </div>
    <div class="form-group">
        <label for="user_data[phone]">Customer Phone</label>
    ...
    <input type="submit" value="Create Order" name="create_order" class="btn btn-block btn-primary">
</form>
<script>
