...
<body>
    ...
    <div class="sw-banner-data d-flex justify-content-center align-items-center">
        <h1 class="text-light sw_main_heading">Contact Us</h1>
    </div>
    <div class="separator"></div>
    <div class="container my-2 contact-info">
        <div class="row">
            <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right text-sw" viewBox="0 0 16 16">
            ...
            <form>
                ...
                <button type="submit" class="btn btn-sw my-2">Submit</button>
            </form>
        </div>
    </div>
    <?php
