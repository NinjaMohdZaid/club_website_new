...
<h2><?php echo $obj->__('update_club',$_SESSION['default_lang']); ?></h2>
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <?php if(!empty($club_data['licence_location'])){?>
            <div class="mb-3">
                <?php echo '<a target="__blank" href="'.$club_data['licence_location'].'"><u>(1) '.$obj->__('file_attached_click_to_view',$_SESSION['default_lang']).'</u></a>' ?>
            </div>
        <?php }?>
    ...
    <div class="form-group">
        <label for="banner"><?php echo $obj->__('upload_photo_of_club',$_SESSION['default_lang']); ?></label>
    ...
    <div class="form-group">
        ...
        <select name="status" class="form-control">
            <option value="A" <?php if($club_data['status'] == 'A'){echo 'selected';} ?>><?php echo $obj->__('active',$_SESSION['default_lang']); ?></option>
            <option value="D" <?php if($club_data['status'] == 'D'){echo 'selected';} ?>><?php echo $obj->__('disabled',$_SESSION['default_lang']); ?></option>
        </select>
    </div>
    ...
    <input type="submit" value="<?php echo $obj->__('update_club',$_SESSION['default_lang']); ?>" name="update_club" class="btn btn-primary" >
