...
<h2><?php echo $obj->__('update_job',$_SESSION['default_lang']); ?></h2>
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <label for="type"><input type="radio" name="type" value="F" <?php if($job_data['type'] == 'F')echo 'checked'; ?>><?php echo $obj->__('full_time',$_SESSION['default_lang']); ?></label>
        <label for="type"><input type="radio" name="type" value="P" <?php if($job_data['type'] == 'P')echo 'checked'; ?>><?php echo $obj->__('part_time',$_SESSION['default_lang']); ?></label>
        <label for="type"><input type="radio" name="type" value="C" <?php if($job_data['type'] == 'C')echo 'checked'; ?>><?php echo $obj->__('contract',$_SESSION['default_lang']); ?></label>
    </div>
    ...
    <div class="form-group">
        ...
        <select name="status" class="form-control">
            <option value="A" <?php if($job_data['status'] == 'A')echo 'selected'; ?>><?php echo $obj->__('active',$_SESSION['default_lang']); ?></option>
            <option value="D" <?php if($job_data['status'] == 'D')echo 'selected'; ?>><?php echo $obj->__('disabled',$_SESSION['default_lang']); ?></option>
        </select>
    </div>
    ...
    <input type="submit" value="<?php echo $obj->__('update_job',$_SESSION['default_lang']); ?>" name="update_job" class="btn btn-primary" >
